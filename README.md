...
- **노드**: 문서(강의안 계열), 개념(55개, 7개 분류), 분류, 고객사, 문서유형
- **엣지**
...
- **로컬 (권장, 전체 색인)**: Windows는 `powershell -ExecutionPolicy Bypass -File scripts\sync_local.ps1 -LectureDir "G:\내 드라이브\강의안\01_강의관련"`
